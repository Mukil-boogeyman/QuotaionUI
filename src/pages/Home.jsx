  ...
  return (
    <div>
      <Grid container sx={{height:"100vh",width:"100%"}}>
        ...
        <Grid item color="grey" sx={{height:"92%",width:"100%",display:"flex"}}>
            ...
            <Grid item size={{md:11.35}}>
              ...
              <Box sx={{marginTop:'10px',marginRight:'2%'}}><Dropdown/></Box>
                ...
                <Box  bgcolor="#F5F7FA" sx={{padding:"1px",height:"90%",border:'0 0 5px 5px',overflow:"hidden"}}>
                  ...
                  <Box bgcolor="white" sx={{width:'90.7%',position:'absolute',marginTop:'510px',zIndex:'100',display:'flex',flexDirection:'row',justifyContent:'space-between'}}>
                  ...
                  <Box sx={{width:"100%",height:"90%",display:"flex"}}>
                    ...
                    <Box bgcolor="#ffffff" sx={{height:"100%",width:"30%",padding:'16px'}}> <Box marginBottom={'20px'}>  <Typography>Quotation</Typography></Box><Quantity/></Box>                    
